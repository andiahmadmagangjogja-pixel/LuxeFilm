...
function mergeConfig(userConfig) {
  ...
  var previewConfig = _extends({}, base.previewConfig, localizedMood && !((_userConfig$previewCo = userConfig.previewConfig) != null && _userConfig$previewCo.defaultCaption) ? {
  ...
  var categories2 = mergeCategoriesConfig(userConfig.categories, {
...
function setSuggested(emoji, skinTone) {
  ...
  var originalUnified = emojiUnified$1(emoji);
...
function emojiNames$1(emoji) {
  var _emoji$EmojiPropertie;
  return (_emoji$EmojiPropertie = emoji[EmojiProperties.name]) != null ? _emoji$EmojiPropertie : [];
}
function emojiName$1(emoji) {
  if (!emoji) {
    return "";
  }
  var names = emojiNames$1(emoji);
  return names[names.length - 1];
}
function unifiedWithoutSkinTone$1(unified) {
  var splat = unified.split("-");
  var _splat$splice = splat.splice(1, 1), skinTone = _splat$splice[0];
  if (skinTonesMapped[skinTone]) {
    return splat.join("-");
...
function emojiUnified$1(emoji, skinTone) {
  var _emojiVariationUnifie;
  var unified = emoji[EmojiProperties.unified];
  if (!skinTone || !emojiHasVariations$1(emoji)) {
    return unified;
  }
  return (_emojiVariationUnifie = emojiVariationUnified$1(emoji, skinTone)) != null ? _emojiVariationUnifie : unified;
}
function useGetEmojisByCategory() {
  ...
  var suggested = import_react.default.useMemo(
    function() {
      var _getSuggested;
  ...
  return function getEmojisByCategory(category) {
    ...
    return (_emojis$emojis$catego = defaultEmojiData.emojis[category]) != null ? _emojis$emojis$catego : [];
  };
}
function emojiVariations$1(emoji) {
  var _emoji$EmojiPropertie2;
  return (_emoji$EmojiPropertie2 = emoji[EmojiProperties.variations]) != null ? _emoji$EmojiPropertie2 : [];
}
function emojiHasVariations$1(emoji) {
  return emojiVariations$1(emoji).length > 0;
}
function emojiVariationUnified$1(emoji, skinTone) {
  return skinTone ? emojiVariations$1(emoji).find(function(variation) {
    return variation.includes(skinTone);
  }) : emojiUnified$1(emoji);
}
function emojiByUnified(unified) {
  ...
  var withoutSkinTone = unifiedWithoutSkinTone$1(unified);
  return allEmojisByUnified[withoutSkinTone];
}
var allEmojis = Object.values(defaultEmojiData.emojis).flat();
var allEmojisByUnified = {};
allEmojis.reduce(function(allEmojis2, Emoji) {
  allEmojis2[emojiUnified$1(Emoji)] = Emoji;
  if (emojiHasVariations$1(Emoji)) {
    emojiVariations$1(Emoji).forEach(function(variation) {
      allEmojis2[variation] = Emoji;
    });
  }
  return allEmojis2;
}, allEmojisByUnified);
function activeVariationFromUnified$1(unified) {
  var _unified$split = unified.split("-"), suspectedSkinTone = _unified$split[1];
  return skinToneVariations.includes(suspectedSkinTone) ? suspectedSkinTone : null;
}
var PickerDataContext = import_react.default.createContext({
  emojiData: {},
  allEmojis: [],
  allEmojisByUnified: {},
  searchIndex: {},
  emojiByUnified,
  activeVariationFromUnified: function activeVariationFromUnified2() {
    return null;
  }
});
function PickerDataProvider(_ref) {
  ...
  var data = import_react.default.useMemo(function() {
    var emojiData = genericEmojiData || defaultEmojiData;
    var newData = JSON.parse(JSON.stringify(emojiData));
    if (customEmojis && customEmojis.length > 0) {
      newData.emojis[Categories.CUSTOM] = customEmojis.map(customToRegularEmoji);
    }
    var emojis2 = newData.emojis || {};
    var allEmojis2 = Object.values(emojis2).flat();
    var allEmojisByUnified2 = {};
    var searchIndex = {};
    allEmojis2.forEach(function(emoji) {
      var unified = emoji[EmojiProperties.unified];
      allEmojisByUnified2[unified] = emoji;
      if (emoji[EmojiProperties.variations]) {
        var _emoji$Keys$variation;
        (_emoji$Keys$variation = emoji[EmojiProperties.variations]) == null ? void 0 : _emoji$Keys$variation.forEach(function(variation) {
          allEmojisByUnified2[variation] = emoji;
        });
      }
      var joinedNameString = (emoji[EmojiProperties.name] || []).join("").toLowerCase().split("");
      joinedNameString.forEach(function(_char) {
        ...
        searchIndex[_char][unified] = emoji;
      });
    });
    return {
      emojiData: newData,
      allEmojis: allEmojis2,
      allEmojisByUnified: allEmojisByUnified2,
      searchIndex
    };
  }, [genericEmojiData, customEmojis]);
  var emojiByUnified2 = import_react.default.useCallback(function(unified) {
  ...
  return import_react.default.createElement(PickerDataContext.Provider, {
    value: _extends({}, data, {
...
function usePickerDataContext() {
  return import_react.default.useContext(PickerDataContext);
}
function useGetEmojisByCategory$1() {
  ...
  var suggestedEmojisModeConfig = useSuggestedEmojisModeConfig();
  var _useUpdateSuggested = useUpdateSuggested(), suggestedUpdated = _useUpdateSuggested[0];
  var suggested = import_react.default.useMemo(function() {
    var _getSuggested;
    var suggested2 = (_getSuggested = getSuggested(suggestedEmojisModeConfig)) != null ? _getSuggested : [];
    return suggested2.map(function(s) {
      var _extends2;
      var emoji = emojiByUnified2(s.unified);
      if (!emoji) return void 0;
      return _extends({}, emoji, (_extends2 = {}, _extends2[EmojiProperties.unified] = s.unified, _extends2));
    }).filter(Boolean);
  }, [suggestedUpdated, suggestedEmojisModeConfig, emojiByUnified2]);
  return function getEmojisByCategory(category) {
    var _emojiData$emojis$cat, _emojiData$emojis;
    if (category === Categories.SUGGESTED) {
      return suggested;
    }
    return (_emojiData$emojis$cat = (_emojiData$emojis = emojiData.emojis) == null ? void 0 : _emojiData$emojis[category]) != null ? _emojiData$emojis$cat : [];
  };
}
function customToRegularEmoji(emoji) {
  var _ref2;
  return _ref2 = {}, _ref2[EmojiProperties.name] = emoji.names.map(function(name) {
    return name.toLowerCase();
  }), _ref2[EmojiProperties.unified] = emoji.id.toLowerCase(), _ref2[EmojiProperties.added_in] = "0", _ref2[EmojiProperties.imgUrl] = emoji.imgUrl, _ref2;
}
...
function useDisallowedEmojis() {
  ...
  return (0, import_react.useMemo)(function() {
    ...
    return allEmojis2.reduce(function(disallowedEmojis, emoji) {
...
function PickerContextProvider(_ref) {
  ...
  var filterRef = (0, import_react.useRef)(searchIndex);
  (0, import_react.useEffect)(function() {
  ...
  var visibleCategoriesState = (0, import_react.useState)([]);
  var emojiSizeState = (0, import_react.useState)(null);
...
function useSkinToneFanOpenState() {
  var _React$useContext0 = (0, import_react.useContext)(PickerContext), skinToneFanOpenState = _React$useContext0.skinToneFanOpenState;
  return skinToneFanOpenState;
}
function useVisibleCategoriesState() {
  var _React$useContext10 = (0, import_react.useContext)(PickerContext), visibleCategoriesState = _React$useContext10.visibleCategoriesState;
  return visibleCategoriesState;
}
function useEmojiSizeState() {
  var _React$useContext11 = (0, import_react.useContext)(PickerContext), emojiSizeState = _React$useContext11.emojiSizeState;
...
function useSearchClearButtonLabelConfig() {
  var _usePickerConfig2 = usePickerConfig(), searchClearButtonLabel = _usePickerConfig2.searchClearButtonLabel;
  return searchClearButtonLabel != null ? searchClearButtonLabel : DEFAULT_SEARCH_CLEAR_BUTTON_LABEL;
}
function useDefaultSkinToneConfig() {
  var _usePickerConfig3 = usePickerConfig(), defaultSkinTone = _usePickerConfig3.defaultSkinTone;
  return defaultSkinTone;
}
function useAllowExpandReactions() {
  var _usePickerConfig4 = usePickerConfig(), allowExpandReactions = _usePickerConfig4.allowExpandReactions;
  return allowExpandReactions;
}
function useSkinTonesDisabledConfig() {
  var _usePickerConfig5 = usePickerConfig(), skinTonesDisabled = _usePickerConfig5.skinTonesDisabled;
  return skinTonesDisabled;
}
function useEmojiStyleConfig() {
  var _usePickerConfig6 = usePickerConfig(), emojiStyle = _usePickerConfig6.emojiStyle;
  return emojiStyle;
}
function useAutoFocusSearchConfig() {
  var _usePickerConfig7 = usePickerConfig(), autoFocusSearch = _usePickerConfig7.autoFocusSearch;
  return autoFocusSearch;
}
function useCategoriesConfig() {
  var _usePickerConfig8 = usePickerConfig(), categories2 = _usePickerConfig8.categories;
  return categories2;
}
function useCategoryIconsConfig() {
  var _usePickerConfig9 = usePickerConfig(), categoryIcons = _usePickerConfig9.categoryIcons;
  return categoryIcons;
}
function useCustomEmojisConfig() {
  var _usePickerConfig0 = usePickerConfig(), customEmojis = _usePickerConfig0.customEmojis;
  return customEmojis;
}
function useOpenConfig() {
  var _usePickerConfig1 = usePickerConfig(), open = _usePickerConfig1.open;
  return open;
}
...
function ElementRefContextProvider(_ref) {
  ...
  var EmojiListRef = (0, import_react.useRef)(null);
...
var ElementRefContext = (0, import_react.createContext)({
  ...
  EmojiListRef: (0, import_react.createRef)(),
...
function preloadEmojiIfNeeded(emoji, emojiStyles2, scrollTop, clientHeight, topOffset, style, dimensions, getEmojiUrl) {
  if (!emoji) {
    return;
  }
  if (emojiStyles2 === EmojiStyle.NATIVE) {
    return;
  }
  ...
  setTimeout(function() {
    ...
    if (isJustBelowViewport) {
      preloadEmoji(getEmojiUrl, emoji, emojiStyles2);
    }
  });
}
...
function originalUnifiedFromEmojiElement(emoji) {
  ...
  if (unified) {
    return unifiedWithoutSkinTone$1(unified);
  }
  return null;
}
...
function useMouseDownHandlers(ContainerRef, mouseEventSource) {
  ...
  var onClick = (0, import_react.useCallback)(function onClick2(event) {
    ...
    closeAllOpenToggles();
    var _emojiFromEvent = emojiFromEvent(event, emojiByUnified2), emoji = _emojiFromEvent[0], unified = _emojiFromEvent[1];
    if (!emoji || !unified) {
      return;
    }
  ...
  var onMouseDown = (0, import_react.useCallback)(function onMouseDown2(event) {
    ...
    var _emojiFromEvent2 = emojiFromEvent(event, emojiByUnified2), emoji = _emojiFromEvent2[0];
    if (!emoji || !emojiHasVariations$1(emoji)) {
      return;
    }
...
function emojiFromEvent(event, lookupEmojiByUnified) {
  var target = event == null ? void 0 : event.target;
  if (!isEmojiElement(target)) {
    return [];
  }
  var _allUnifiedFromEmojiE = allUnifiedFromEmojiElement(target), unified = _allUnifiedFromEmojiE.unified, originalUnified = _allUnifiedFromEmojiE.originalUnified;
  var resolvedUnified = unified != null ? unified : originalUnified;
  if (!resolvedUnified) {
    return [];
  }
  var emoji = lookupEmojiByUnified(resolvedUnified);
  if (!emoji) {
    return [];
  }
  return [emoji, unified != null ? unified : resolvedUnified];
}
function emojiClickOutput(emoji, activeSkinTone, activeEmojiStyle, getEmojiUrl) {
  var names = emojiNames$1(emoji);
  if (isCustomEmoji(emoji)) {
    var _unified = emojiUnified$1(emoji);
    return {
      activeSkinTone,
      emoji: _unified,
  ...
  var unified = emojiUnified$1(emoji, activeSkinTone);
  return {
    activeSkinTone,
    ...
    names,
    unified,
    unifiedWithoutSkinTone: emojiUnified$1(emoji)
  };
}
...
function getAriaLabel(emojiNames2) {
  return emojiNames2[emojiNames2.length - 1];
}
...
function ViewOnlyEmoji(_ref) {
  ...
  var emojiToRender = emoji ? emoji : emojiByUnified2(unified);
  if (!emojiToRender) {
    return null;
  }
...
function Reactions() {
  ...
  return (0, import_react.createElement)("ul", {
    ...
    var emoji = emojiByUnified(reaction);
    if (!emoji) {
      return null;
    }
...
function useOnScroll(BodyRef) {
  var closeAllOpenToggles = useCloseAllOpenToggles();
  var _useState = (0, import_react.useState)(0), scrollTop = _useState[0], setScrollTop = _useState[1];
  (0, import_react.useEffect)(function() {
    var bodyRef = BodyRef.current;
    if (!bodyRef) {
      return;
...
function shouldVirtualize(_ref) {
  var scrollTop = _ref.scrollTop, clientHeight = _ref.clientHeight, topOffset = _ref.topOffset, style = _ref.style, dimensions = _ref.dimensions;
  if (!style || !dimensions) {
    return false;
  }
  var emojiTop = topOffset + style.top;
...
function useCategoryHeight(emojiCount) {
  ...
  var PickerMainRef = usePickerMainRef();
  var emojiSizeRef = (0, import_react.useRef)();
  ...
  var _React$useState = (0, import_react.useState)(), dimensions = _React$useState[0], setDimensions = _React$useState[1];
  var computeAndSetDimensions = (0, import_react.useCallback)(function() {
    ...
    var emojiSize = emojiSizeFromContext || measured || emojiSizeRef.current || EMOJI_SIZE_DEFAULT;
...
function useEmojiVirtualization(_ref) {
  var categoryEmojis = _ref.categoryEmojis, topOffset = _ref.topOffset, onHeightReady = _ref.onHeightReady, scrollTop = _ref.scrollTop, isCategoryVisible = _ref.isCategoryVisible;
  ...
  var isVirtualized = function isVirtualized2(style) {
    var _BodyRef$current$clie, _BodyRef$current;
    return dimensions && BodyRef.current && shouldVirtualize({
      scrollTop,
  ...
  var emojis2 = emojisToPush.reduce(function(accumulator, emoji, index) {
    ...
    accumulator.push((0, import_react.createElement)(ClickableEmoji, {
      showVariations,
      key: unified,
      emoji,
      unified,
...
function MeasureEmoji() {
  ...
  var firstCategory = categories2[0];
  var dummyEmoji = getEmojisByCategory(categoryFromCategoryConfig(firstCategory))[0];
  var unified = dummyEmoji ? emojiUnified$1(dummyEmoji, activeSkinTone) : "";
  if (!dummyEmoji) {
    return null;
  }
...
function EmojiList(_ref) {
  ...
  var categories2 = useCategoriesConfig();
  var _React$useState = (0, import_react.useState)({}), categoryHeights = _React$useState[0], setCategoryHeights = _React$useState[1];
  var EmojiListRef = useEmojiListRef();
  ...
  return (0, import_react.createElement)("ul", {
    ...
    ref: EmojiListRef
  }, (0, import_react.createElement)(MeasureEmoji, null), categories2.map(function(categoryConfig) {
    var category = categoryFromCategoryConfig(categoryConfig);
...
function RenderCategory(_ref2) {
  var categoryEmojis = _ref2.categoryEmojis, categoryConfig = _ref2.categoryConfig, topOffset = _ref2.topOffset, onHeightReady = _ref2.onHeightReady, scrollTop = _ref2.scrollTop;
  var _useVisibleCategories = useVisibleCategoriesState(), visibleCategories = _useVisibleCategories[0];
  ...
  return (0, import_react.createElement)(EmojiCategory, {
    ...
    hidden: !emojis2.length && virtualizedCounter === 0
  }, emojis2);
}
...
function Body() {
  ...
  return (0, import_react.createElement)("div", {
    ...
    ref: BodyRef
  }, (0, import_react.createElement)(EmojiVariationPicker, null), (0, import_react.createElement)(EmojiList, {
    scrollTop
  }));
}
  ...
  (0, import_react.useEffect)(function() {
    ...
    var observer = new IntersectionObserver(function(entries) {
      ...
      var visibleCats = ratios.filter(function(_ref2) {
        var id2 = _ref2[0], ratio2 = _ref2[1];
        return ratio2 > 0 || intersectingCategories.get(id2);
      }).map(function(_ref3) {
        var id2 = _ref3[0];
        return id2;
      });
      ...
      if ((lastCategory == null ? void 0 : lastCategory[1]) == 1) {
...
function CategoryNavigation() {
  ...
  return (0, import_react.createElement)("div", {
    ...
    return (0, import_react.createElement)(CategoryButton, {
      ...
      allowNavigation,
      categoryConfig,
      customIcon: categoryIcons[category],
      onClick: function onClick() {
...
function EmojiPicker(props) {
  return (0, import_react.createElement)(ElementRefContextProvider, null, (0, import_react.createElement)(PickerStyleTag, null), (0, import_react.createElement)(PickerConfigProvider, Object.assign({}, props), (0, import_react.createElement)(PickerDataProvider, null, (0, import_react.createElement)(ContentControl, null))));
}
